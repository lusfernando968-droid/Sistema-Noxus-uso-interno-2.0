...
async function check() {
    console.log('--- Verificando Estrutura Financeiro ---');
    ...
    if (fError) {
        ...
        console.log('Exemplo financeiro_geral:', financeiro[0]);
    } else {
        console.log('financeiro_geral está vazia.');
    }
    ...
    if (tError) {
        ...
        console.log('Exemplo transacoes:', transacoes[0]);
    } else {
        console.log('transacoes está vazia.');
    }
}
