...
import { Users, Briefcase, Calendar, FileText, LayoutGrid, MessageSquare } from "lucide-react";
import { Link, useLocation } from "react-router-dom";
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from "@/components/ui/tooltip";
import { useNavigation } from "@/contexts/NavigationContext";

const menuItems = [
    { icon: LayoutGrid, label: "Central", path: "/central-atendente" },
    { icon: Users, label: "Clientes", path: "/clientes" },
    { icon: Briefcase, label: "Projetos", path: "/projetos" },
    { icon: Calendar, label: "Agendamentos", path: "/agendamentos" },
    { icon: FileText, label: "Orçamentos", path: "/orcamento" },
    { icon: MessageSquare, label: "WhatsApp", path: "/conversas-whatsapp" },
];
...
export function DockAssistant() {
    ...
    const getIconScale = (index: number) => {
        ...
        // Escala de 1 a 1.3 baseada na proximidade
    ...
    const getDockScale = () => {
        ...
        // O container cresce proporcionalmente
